...
<head>
  ...
  <title>tugas-11 | Portofolio</title>
</head>
        ...
        <div class="board">
          <div class="flex-column">
            <div class="card-table">
              ...
              <div class="body-card">
                <a href="/tugas-11/views/user/create.php">
                ...
                <table class="table" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><img src="/tugas-11/views/asset/img/<?= $data[$i]['gambar_porto']; ?>" alt="" width="150"></td>
                    <td><?= $data[$i]['username']; ?></td>
                    <td>
                      <div class="grup-action-btn">
                        <a href="/tugas-11/views/user/update.php?id=<?= $data[$i]['id_porto']?>">
                          <button class="edit-btn">Edit</button>
                        </a>
                        <a href="/tugas-11/app/controllers/PortofolioController.php?action=delete&id=<?= $data[$i]['id_porto']?>" onclick="return confirm('Anda yakin menghapus data ini?');">
