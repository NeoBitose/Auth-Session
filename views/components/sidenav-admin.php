  ...
  <div class="nav">
    <ul>
      <li class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">
        <a href="/tugas-11/views/admin/dashboard.php" class="nav-link">
          <i class="icon-nav">
      ...
      <li class="">
        <a href="/tugas-11/views/user/dashboard.php" class="nav-link">
          <i class="icon-nav">
            <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M4.04999 17.55H14.85V4.04997H4.04999V17.55ZM4.04999 28.35H14.85V20.25H4.04999V28.35ZM17.55 28.35H28.35V14.85H17.55V28.35ZM17.55 4.04997V12.15H28.35V4.04997H17.55Z"
      ...
      <li class="<?php echo basename($_SERVER['PHP_SELF']) == 'portofolio.php' ? 'active' : ''; ?>">
        <a href="/tugas-11/views/admin/portofolio.php" class="nav-link">
          <i class="icon-nav">
            <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
